...
print("To what unit?")
second_unit=input()
print("How much?",origin_unit)
how_much=int(input())
answer=0
if origin_unit=="kilometeres" and second_unit=="miles":
    answer = how_much/1,609
elif origin_unit=="kilometeres" and second_unit=="foot":
    answer = how_much*3281
elif origin_unit=="foot" and second_unit=="kilometeres":
    answer = how_much/3281
elif origin_unit=="foot" and second_unit=="miles":
    answer = how_much/5280
elif origin_unit=="miles" and second_unit=="kilometeres":
    answer = how_much*1,609
elif origin_unit=="miles" and second_unit == "foot":
    answer =how_much*5280
print(answer)